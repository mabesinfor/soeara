...
class PetitionPolicy
{
    ...
    {
        return $user->can('view_any_petition');
    }
    ...
    {
        return $user->can('delete_any_petition');
    }
    ...
    {
        return $user->can('force_delete_petition');
    }
    ...
    {
        return $user->can('force_delete_any_petition');
    }
    ...
    {
        return $user->can('restore_petition');
    }
    ...
    {
        return $user->can('restore_any_petition');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Petition $petition): bool
    {
        return $user->can('replicate_petition');
    }
    ...
    {
        return $user->can('reorder_petition');
    }
}
