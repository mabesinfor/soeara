...
@section('content')
    <div class="relative mx-auto py-8 md:text-center pl-2 md:pl-0">
        ...
        <div class="relative z-20 flex flex-col justify-center items-center gap-4 my-10">
            ...
            <a href="http://127.0.0.1:8000/auth/google/redirect" class="bg-[#e00a24] rounded-xl py-[9px] px-[22px] font-semibold text-[17px] transition ease-in-out duration-500 hover:bg-[#c94958] flex items-center gap-2">
