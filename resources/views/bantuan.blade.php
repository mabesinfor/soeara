...
<div class="relative bg-[#121212] p-4 md:p-8 text-white max-w-screen-lg mx-auto px-4 md:px-8">
    <div class="space-y-8">
        ...
        <a href="#panduan" id="panduan">
            ...
            <p class="mt-2 md:mt-4 text-base md:text-lg text-justify">
                Bagian Panduan menyediakan tutorial mendetail tentang berbagai fitur dan layanan yang kami tawarkan di Soeara. Mulai dari cara membuat akun hingga tips menjaga keamanan informasi pribadi Anda, kami menyediakan semua yang Anda butuhkan untuk menggunakan Soeara dengan efisien.
            </p>
            <p class="mt-2 md:mt-4 text-base md:text-lg text-justify">
                Panduan ini mencakup cara membuat petisi baru, mendukung petisi, melihat daftar petisi yang sedang berlangsung, mengirim komentar, membagikan petisi, mengunjungi petisi, menghapus petisi, menutup atau membuka petisi, menyatakan kemenangan petisi, dan menyukai petisi atau komentar.
            </p>
        </a>
        ...
        <a href="#ketentuan" id="ketentuan">
            ...
            <p class="mt-2 md:mt-4 text-base md:text-lg text-justify">
                Syarat dan Ketentuan ini menguraikan aturan dan regulasi penggunaan Soeara. Dengan mengakses platform ini, kami mengasumsikan Anda menerima syarat dan ketentuan ini sepenuhnya. Jika Anda tidak setuju dengan semua syarat dan ketentuan yang disebutkan di halaman ini, harap jangan lanjutkan menggunakan Soeara.
            </p>
            <p class="mt-2 md:mt-4 text-base md:text-lg text-justify">
        ...
        <a href="#cookie" id="cookie">
            ...
            <p class="mt-2 md:mt-4 text-base md:text-lg text-justify">
                Soeara menggunakan cookie untuk meningkatkan pengalaman Anda saat menavigasi platform kami. Cookie membantu kami memahami bagaimana Anda menggunakan Soeara, yang memungkinkan kami meningkatkan layanan dan menyediakan konten yang lebih relevan bagi Anda. Anda dapat mempelajari lebih lanjut tentang penggunaan cookie dan cara mengelola pengaturannya di bagian ini.
            </p>
            <p class="mt-2 md:mt-4 text-base md:text-lg text-justify">
