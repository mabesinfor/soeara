...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {{-- Start Konten Petisi --}}
        <div class="bg-transparent p-4 col-span-2 ml-20">
            <div class="relative z-30 flex flex-col gap-3 p-3 bg-[#303030]/50 ring-1 ring-[#646464] w-full rounded-xl ml-20">
        ...
        {{-- Start Dukung Petisi --}}
        <div class="bg-transparent mr-20 p-4 col-span-2 ml-20">
            {{-- Start Progress Bar --}}
            <div class="border border-[#C82323] rounded-xl w-3/4">
                <div class="w-full h-2 rounded-full">
                    <div class="h-full bg-[#C82323] rounded-full" style="width: 50%;"></div>
                </div>
            </div>
            <div class="bg-transparent flex justify-between items-center w-3/4 mt-2">
                <div>
                    <h3 class="text-xl text-start font-bold text-[#C82323]">5.701</h3>
                    <p class="text-start text-[#C82323]">Pendukung</p>
                </div>
                <div>
                    <h3 class="text-xl text-right font-bold">10.000</h3>
                    <p class="text-right">Tujuan Berikutnya</p>
                </div>
            </div>
            {{-- End Progress Bar --}}

            <h3 class="text-2xl text-start font-bold mb-3 mt-5">Dukung petisi ini</h3>
            <div class="flex items-center gap-4 mb-4">
                <img src="{{ url('pic5.svg') }}">
                Maria Elizabeth Putri
            </div>
            <p class="opacity-80">Saya mendukung petisi ini karena ... (tidak wajib)</p>
            <form action="/submit" method="post">
                <textarea class="w-3/4 p-2 rounded-md bg-transparent border border-gray-600 mt-3"></textarea>
                <button type="submit" class="w-3/4 mt-2 bg-[#C82323] hover:bg-[#dc4d4d] text-white rounded-xl px-4 py-2 font-bold italic">Dukung Petisi Ini</button>
            </form>
        </div>
        {{-- End Dukung Petisi --}}

        <div class="bg-transparent w-full p-4 col-span-2 ml-20">
            <h3 class="text-2xl text-start font-bold mb-7 ml-20">24 Komentar</h3>
            {{-- Start submit komentar --}}
            <div class="flex items-start gap-4 mb-4 ml-20">
            ...
            {{-- Start Komentar --}}
            <div class="flex items-start gap-4 mb-4 ml-20 mt-5">
    ...
    <div class="w-1/2 ml-20 flex p-5 mb-20">
        <div class="relative z-30 flex p-3 bg-[#303030]/50 ring-1 ring-[#646464] w-full rounded-xl ml-20">
