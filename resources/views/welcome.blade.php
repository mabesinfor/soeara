...
@section('content')
    <div class="relative mx-auto py-8 md:text-center pl-2 md:pl-0">
        ...
        <div class="absolute z-30 md:w-full md:px-4 lg:px-64 mt-14 flex gap-4 items-center">
            ...
            <div class="flex flex-col md:flex-row gap-3 p-3 bg-[#303030] ring-1 ring-[#646464] w-full rounded-xl">
        ...
        <div id="stats" class="relative z-20 -mt-[34rem] md:-mt-40 flex flex-col md:flex-row justify-center items-center gap-10 lg:gap-20">
            <div class="p-3 bg-[#303030] ring-1 ring-[#646464] rounded-xl">
        ...
        <div class="text-left md:px-10 lg:px-40 py-20 flex flex-col gap-10">
            ...
            <div class="relative z-30 flex flex-col md:flex-row gap-3 p-3 bg-[#303030] ring-1 ring-[#646464] w-full rounded-xl">
                <div class="w-full md:w-1/2 rounded-lg bg-[#121212]">
            ...
            <div class="w-full flex justify-center">
                <div class="relative z-30 flex p-3 bg-[#303030] ring-1 ring-[#646464] w-fit rounded-xl">
                    <div class="w-full rounded-lg bg-[#121212] py-3 px-6 md:px-40">
                        Telusuri lebih banyak petisi <a href="" class="hover:underline text-[#C82323] hover:text-[#dc4d4d] font-semibold">disini</a>
                    </div>
                </div>
            </div>
        </div>
