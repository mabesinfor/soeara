...
@section('content')
    ...
    <div class="relative bg-[#121212] p-8">
        <img src="{{ url('vector-1.svg') }}" class="absolute inset-0 h-1/3 object-cover z-[0]">
        <div class="relative flex space-x-4 mx-auto max-w-screen-lg z-[1]">
            <h2 class="text-5xl font-bold">Tentang</h2>
            <h2 class="text-5xl font-black text-[#C82323] italic">Soeara</h2>
            <h2 class="text-5xl font-bold">(Soedirman Berbicara)</h2>
        </div>
        ...
        <div class="relative p-7 bg-[#1E1E1E] mt-4 mb-5 rounded-xl mx-auto w-full max-w-screen-lg px-20 z-[1]">
            <h3 class="text-white text-center font-bold text-2xl mb-6">Memberi Suara untuk Perubahan Universitas Jenderal Soedirman</h3>
        ...
        <img src="{{ url('vector-2.svg') }}" class="absolute bottom-0 right-0 h-1/3 object-cover z-0">
    </div>
@endsection